...
**成果：**
- 完成PC端项目的重构迁移，从 eggjs 迁移到 React，解决了原有项目长期的内存泄漏问题，同时降低了了项目的上手难度，大大缩减了新同学熟悉业务、承接需求的时间周期，提升效率。
- 独自搭建了移动端包括小程序内的登录、下单、支付流程，其中包括部分移动端页面直接嵌入小程序的逻辑适配；基于产品选择的第三方支付、结算供应商，完成微信、支付宝支付流程梳理与开发，做到比产品经理更了解产品本身。
- 协助部门 TL 进行团队建设工作，包括人员面试，组织组内技术分享，担任mentor帮助新同学、校招同学熟悉开发流程与项目规范，指导2名校招同学完成需求承接。
